...
const CustomerFeedback: React.FC = () => {
  ...
  const { rideId, driverInfo, rideDetails } = route.params || {};
  ...
  const positiveTags = [
    'Safe driving', 'Polite', 'Good communication', 'On time',
    'Clean vehicle', 'Friendly', 'Professional', 'Helpful'
  ];

  const negativeTags = [
    'Reckless driving', 'Rude', 'Late', 'Poor communication',
    'Dirty vehicle', 'Unhelpful', 'Unprofessional'
  ];
  ...
  const TagSelector = ({ tags, selectedTags, onTagToggle, isPositive = true }: {
    ...
    const getTitle = () => isPositive ? '👍 What did the driver do well?' : '👎 What could the driver improve?';
    return (
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        {driverInfo && (
          <View style={styles.userInfoCard}>
            <Text style={styles.userInfoTitle}>Rate Driver</Text>
            <View style={styles.userProfile}>
              <View style={styles.profileImageContainer}>
                {driverInfo.profilePhoto ? (
                  <Image source={{ uri: driverInfo.profilePhoto }} style={styles.profileImage} />
                ) : (
        ...
        <View style={styles.detailedRatings}>
          <Text style={styles.sectionTitle}>Rate Driving & Service</Text>
          <StarRating rating={drivingRating} onRatingChange={setDrivingRating} label="Driving Skills" />
          <StarRating rating={punctualityRating} onRatingChange={setPunctualityRating} label="Punctuality" />
        </View>
        ...
        <View style={styles.commentsSection}>
          ...
          <TextInput
            ...
            placeholder="Share your experience or additional feedback..."
